        ...
        <div className="h-screen flex justify-center items-center bg-black bg-opacity-40">
          ...
          <div className='z-20 md:w-[30%] mt-12 md:mt-0'>
            <div className='flex flex-col items-center justify-center'> 
              ...
              <h3 className='text-base font-normal text-[#091913] text-center mx-2'>
              Funds will be released fully to provided wallet
              <br />address once it has been confirmed by the authorized
              <br />reference provided.
              </h3>
